...
from osc_validation.utils.tool_helpers import single_channel_temp_spec
...
def test_gtgen_run_raises_when_temp_trace_missing(tmp_path, monkeypatch):
    ...
    expected_temp_spec = single_channel_temp_spec(output_spec, "_gtgen", "SensorView")
    ...
    assert not expected_temp_spec.path.exists()
