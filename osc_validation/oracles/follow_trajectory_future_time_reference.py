...
class FollowTrajectoryFutureTimeReferenceCaseSpec:
...
@dataclass(frozen=True)
class FollowTrajectoryFutureTimeReferenceCaseResult:
    xosc_path: Path
    reference_channel_spec: ChannelSpecification


def build_follow_trajectory_future_time_reference_case(
    spec: FollowTrajectoryFutureTimeReferenceCaseSpec,
) -> FollowTrajectoryFutureTimeReferenceCaseResult:
    xosc_result = build_follow_trajectory_future_time_reference_xosc(
        FollowTrajectoryFutureTimeReferenceXoscRequest(
            output_xosc_path=spec.output_xosc_path,
            actor=spec.actor,
            init_pose=spec.init_pose,
            init_speed_mps=spec.init_speed_mps,
    ...
    return FollowTrajectoryFutureTimeReferenceCaseResult(
