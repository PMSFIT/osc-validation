...
@pytest.fixture(
    scope="module",
    params=[
        "https://raw.githubusercontent.com/thomassedlmayer/omega-prime/refs/heads/omega-prime-osi-rule-yml/docs/osirules/omega-prime-osi_3-7-0.yml"
    ],  # Omega-Prime OSI 3.7.0 rules
)
...
def test_trajectory_and_omegaprime_compliance(
    osi_trace: Path,
    odr_file: Path,
    yaml_ruleset: Path,
