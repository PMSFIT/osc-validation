...
def test_distance_longitudinal_start_trigger_activates_target_actor(
    ...
    osc_path = osi2osc(
        ...
        path_xosc=tmp_path / "osi2osc_distance_longitudinal_start_trigger.xosc",
        path_xodr=odr_file,
    )
    transform_result = apply_trigger_transform(
        TriggerTransformRequest(
            ...
            output_reference_channel_spec=OSIChannelSpecification(
                path=tmp_path
                / "reference_distance_longitudinal_start_trigger_comparison.mcap",
    ...
    tool_trace_channel_spec = generate_tool_trace(
        ...
        osi_output_spec=OSIChannelSpecification(
            path=tmp_path / "tool_trace_distance_longitudinal_start_trigger.mcap",
            message_type="SensorView",
            metadata={
    ...
    area, cl, mae, best_lag_frames = metric.compute(
        ...
        / "trajectory_alignment_similarity_report_distance_longitudinal_start_trigger.txt",
        time_tolerance=0.01,
