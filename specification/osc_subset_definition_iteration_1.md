...
This subset was covered by the original simple trajectory replay validation:

- `osc_validation/validation/scenario/trajectories/val_simple_trajectories.py`
...
The validation of adherence to the most minimal subset specification (Iteration 1) can be checked with the corresponding extension of the OSC Quality Checker:
