### 1. Subset Definition: Most Minimal Subset (Iteration 1)

- Very simple OpenSCENARIO representation of OSI Trace
- Only vehicle bounding box/axles and one corresponding polyline trajectory
